...
#define FLASH_SIZE_RSVD_U3  CNTR_INWORD_PER_COMM

#define FLASH_BASE_RSVD_U4  (FLASH_BASE_PARAMS + (CNTR_INWORD_PER_COMM*3 + CNTR_INWORD_PER_BIG*2 + CNTR_INWORD_PER_SMALL*10)*2)
#define FLASH_SIZE_RSVD_U4  CNTR_INWORD_PER_SMALL

#define FLASH_BASE_RSVD_U5  (FLASH_BASE_PARAMS + (CNTR_INWORD_PER_COMM*3 + CNTR_INWORD_PER_BIG*2 + CNTR_INWORD_PER_SMALL*11)*2)
#define FLASH_SIZE_RSVD_U5  CNTR_INWORD_PER_SMALL

#define FLASH_BASE_RSVD_U6  (FLASH_BASE_PARAMS + (CNTR_INWORD_PER_COMM*3 + CNTR_INWORD_PER_BIG*2 + CNTR_INWORD_PER_SMALL*12)*2)
#define FLASH_SIZE_RSVD_U6  CNTR_INWORD_PER_SMALL

#define FLASH_BASE_RSVD_U7  (FLASH_BASE_PARAMS + (CNTR_INWORD_PER_COMM*3 + CNTR_INWORD_PER_BIG*2 + CNTR_INWORD_PER_SMALL*13)*2)
#define FLASH_SIZE_RSVD_U7  CNTR_INWORD_PER_SMALL

#define FLASH_BASE_RSVD_U8  (FLASH_BASE_PARAMS + (CNTR_INWORD_PER_COMM*3 + CNTR_INWORD_PER_BIG*2 + CNTR_INWORD_PER_SMALL*14)*2)
...
#define BINA_DATA_PER_INWD  4// BIN File
...
typedef enum {
    ...
    PARAM_ID_RSVD_U3,// IAP File Name
    PARAM_ID_RSVD_U4,// IAP Got Size Already
    PARAM_ID_RSVD_U5,
    PARAM_ID_RSVD_U6,
    PARAM_ID_RSVD_U7,
    PARAM_ID_RSVD_U8
...
#define IAP_REQ_RN  "7D8A"// APP Set: IAP is running, if reboot unexpectly, just go on
